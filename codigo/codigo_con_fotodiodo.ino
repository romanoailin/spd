...
Se incorpora un fotodiodio que en caso de llegar al máximo del sensor deja el contador en 99
*/
...
//función que en caso de que el fotodiodo se encuentre al máximo, el contador muestra 99
void leeFotodiodo(int iluminacion)
{
  iluminacion = analogRead(LUZ);	
  if (iluminacion == 0) {
    unidades = 9;
    decenas = 9;
  }
